...
################################################################
# This is a generated script based on design: serial_test
#
...
# source serial_test_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# axis_demux, axis_mux, frame_extractor, hann_win_applayer, hann_win_applayer, neighbors_resize_wrapper, rfft_axis_wrapper, rfft_axis_wrapper, spi_master_axis, threshold_axis
...
proc create_root_design { parentCell } {
  ...
  set miso_spi [ create_bd_port -dir I miso_spi ]
  set mosi_spi [ create_bd_port -dir O mosi_spi ]
  ...
  if { [catch {set axis_mux_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property CONFIG.WIDTH {32} $axis_mux_0


  # Create instance: axis_subset_converter_0, and set properties
  set axis_subset_converter_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_subset_converter:1.1 axis_subset_converter_0 ]
  set_property -dict [list \
    CONFIG.DEFAULT_TLAST {129} \
  ...
  if { [catch {set hann_win_applayer_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property CONFIG.DATA_WIDTH {16} $hann_win_applayer_0
  ...
  if { [catch {set hann_win_applayer_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property CONFIG.DATA_WIDTH {16} $hann_win_applayer_1


  # Create instance: neighbors_resize_wra_0, and set properties
  set block_name neighbors_resize_wrapper
  set block_cell_name neighbors_resize_wra_0
  if { [catch {set neighbors_resize_wra_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $neighbors_resize_wra_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: rfft_axis_wrapper_0, and set properties
  set block_name rfft_axis_wrapper
  set block_cell_name rfft_axis_wrapper_0
  if { [catch {set rfft_axis_wrapper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $rfft_axis_wrapper_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: rfft_axis_wrapper_1, and set properties
  set block_name rfft_axis_wrapper
  set block_cell_name rfft_axis_wrapper_1
  if { [catch {set rfft_axis_wrapper_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $rfft_axis_wrapper_1 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: spi_master_axis_0, and set properties
  set block_name spi_master_axis
  set block_cell_name spi_master_axis_0
  if { [catch {set spi_master_axis_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $spi_master_axis_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [list \
    CONFIG.CS_HOLD_TIME {20} \
    CONFIG.CS_IDLE_GAP {7000} \
    CONFIG.CS_SETUP_TIME {20} \
  ] $spi_master_axis_0
  ...
  # Create instance: threshold_axis_0, and set properties
  set block_name threshold_axis
  set block_cell_name threshold_axis_0
  if { [catch {set threshold_axis_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $threshold_axis_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [list \
...
MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#PMU GPI 0#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#PMU GPI 5#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#PMU GPO 3#UART 1#UART\
1#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO##########################} \
    CONFIG.PSU_MIO_TREE_SIGNALS {gpio0[0]#gpio0[1]#gpio0[2]#gpio0[3]#gpio0[4]#gpio0[5]#gpio0[6]#gpio0[7]#gpio0[8]#gpio0[9]#gpio0[10]#gpio0[11]#gpio0[12]#gpio0[13]#gpio0[14]#gpio0[15]#gpio0[16]#gpio0[17]#gpio0[18]#gpio0[19]#gpio0[20]#gpio0[21]#gpio0[22]#gpio0[23]#gpio0[24]#gpio0[25]#gpi[0]#gpio1[27]#gpio1[28]#gpio1[29]#gpio1[30]#gpi[5]#gpio1[32]#gpio1[33]#gpio1[34]#gpo[3]#txd#rxd#gpio1[38]#gpio1[39]#gpio1[40]#gpio1[41]#gpio1[42]#gpio1[43]#gpio1[44]#gpio1[45]#gpio1[46]#gpio1[47]#gpio1[48]#gpio1[49]#gpio1[50]#gpio1[51]##########################}\
\
...
\
  ...
  connect_bd_intf_net -intf_net axis_demux_0_m_axis_0 [get_bd_intf_pins axis_demux_0/m_axis_0] [get_bd_intf_pins hann_win_applayer_0/s_axis]
  connect_bd_intf_net -intf_net axis_demux_0_m_axis_1 [get_bd_intf_pins axis_demux_0/m_axis_1] [get_bd_intf_pins hann_win_applayer_1/s_axis]
  ...
  connect_bd_intf_net -intf_net fifo_generator_0_M_AXIS [get_bd_intf_pins fifo_generator_0/M_AXIS] [get_bd_intf_pins fifo_generator_2/S_AXIS]
  connect_bd_intf_net -intf_net fifo_generator_1_M_AXIS [get_bd_intf_pins axis_subset_converter_0/S_AXIS] [get_bd_intf_pins fifo_generator_1/M_AXIS]
  connect_bd_intf_net -intf_net fifo_generator_2_M_AXIS [get_bd_intf_pins axis_demux_0/s_axis] [get_bd_intf_pins fifo_generator_2/M_AXIS]
  connect_bd_intf_net -intf_net frame_extractor_0_m_axis [get_bd_intf_pins frame_extractor_0/m_axis] [get_bd_intf_pins rfft_axis_wrapper_1/s_axis]
  connect_bd_intf_net -intf_net hann_win_applayer_0_m_axis [get_bd_intf_pins frame_extractor_0/s_axis] [get_bd_intf_pins hann_win_applayer_0/m_axis]
  connect_bd_intf_net -intf_net hann_win_applayer_1_m_axis [get_bd_intf_pins hann_win_applayer_1/m_axis] [get_bd_intf_pins rfft_axis_wrapper_0/s_axis]
  ...
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tdata [get_bd_pins axi_dma_0/m_axis_mm2s_tdata] [get_bd_pins xlslice_0/Din]
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tlast [get_bd_pins axi_dma_0/m_axis_mm2s_tlast] [get_bd_pins neighbors_resize_wra_0/s_axis_tlast]
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tvalid [get_bd_pins axi_dma_0/m_axis_mm2s_tvalid] [get_bd_pins neighbors_resize_wra_0/s_axis_tvalid]
  connect_bd_net -net axi_dma_0_s_axis_s2mm_tready [get_bd_pins axi_dma_0/s_axis_s2mm_tready] [get_bd_pins axis_subset_converter_0/m_axis_tready]
  connect_bd_net -net axis_mux_0_m_axis_tdata [get_bd_pins axis_mux_0/m_axis_tdata] [get_bd_pins fifo_generator_1/s_axis_tdata]
  connect_bd_net -net axis_mux_0_m_axis_tvalid [get_bd_pins axis_mux_0/m_axis_tvalid] [get_bd_pins fifo_generator_1/s_axis_tvalid]
  connect_bd_net -net axis_mux_0_s_axis_tready_0 [get_bd_pins axis_mux_0/s_axis_tready_0] [get_bd_pins util_vector_logic_0/Op2]
  connect_bd_net -net axis_mux_0_s_axis_tready_1 [get_bd_pins axis_mux_0/s_axis_tready_1] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net axis_subset_converter_0_m_axis_tdata [get_bd_pins axi_dma_0/s_axis_s2mm_tdata] [get_bd_pins axis_subset_converter_0/m_axis_tdata]
  connect_bd_net -net axis_subset_converter_0_m_axis_tlast [get_bd_pins axi_dma_0/s_axis_s2mm_tlast] [get_bd_pins axis_subset_converter_0/m_axis_tlast]
  connect_bd_net -net axis_subset_converter_0_m_axis_tvalid [get_bd_pins axi_dma_0/s_axis_s2mm_tvalid] [get_bd_pins axis_subset_converter_0/m_axis_tvalid]
  connect_bd_net -net axis_subset_converter_0_s_axis_tready [get_bd_pins axis_subset_converter_0/s_axis_tready] [get_bd_pins fifo_generator_1/m_axis_tready]
  connect_bd_net -net fifo_generator_0_s_axis_tready [get_bd_pins fifo_generator_0/s_axis_tready] [get_bd_pins spi_master_axis_0/m_axis_tready]
  connect_bd_net -net fifo_generator_1_m_axis_tdata [get_bd_pins axis_subset_converter_0/s_axis_tdata] [get_bd_pins fifo_generator_1/m_axis_tdata]
  connect_bd_net -net fifo_generator_1_m_axis_tvalid [get_bd_pins axis_subset_converter_0/s_axis_tvalid] [get_bd_pins fifo_generator_1/m_axis_tvalid]
  connect_bd_net -net fifo_generator_1_s_axis_tready [get_bd_pins axis_mux_0/m_axis_tready] [get_bd_pins fifo_generator_1/s_axis_tready]
  connect_bd_net -net miso_0_1 [get_bd_ports miso_spi] [get_bd_pins spi_master_axis_0/miso]
  connect_bd_net -net neighbors_resize_wra_0_m_axis_tdata [get_bd_pins neighbors_resize_wra_0/m_axis_tdata] [get_bd_pins threshold_axis_0/s_axis_tdata]
  connect_bd_net -net neighbors_resize_wra_0_m_axis_tlast [get_bd_pins neighbors_resize_wra_0/m_axis_tlast] [get_bd_pins threshold_axis_0/s_axis_tlast]
  connect_bd_net -net neighbors_resize_wra_0_m_axis_tvalid [get_bd_pins neighbors_resize_wra_0/m_axis_tvalid] [get_bd_pins threshold_axis_0/s_axis_tvalid]
  connect_bd_net -net neighbors_resize_wra_0_s_axis_tready [get_bd_pins axi_dma_0/m_axis_mm2s_tready] [get_bd_pins neighbors_resize_wra_0/s_axis_tready]
  connect_bd_net -net rfft_axis_wrapper_0_m_axis_tdata [get_bd_pins axis_mux_0/s_axis_tdata_1] [get_bd_pins rfft_axis_wrapper_0/m_axis_tdata]
  connect_bd_net -net rfft_axis_wrapper_0_m_axis_tvalid [get_bd_pins axis_mux_0/s_axis_tvalid_1] [get_bd_pins rfft_axis_wrapper_0/m_axis_tvalid]
  connect_bd_net -net rfft_axis_wrapper_1_m_axis_tdata [get_bd_pins axis_mux_0/s_axis_tdata_0] [get_bd_pins rfft_axis_wrapper_1/m_axis_tdata]
  connect_bd_net -net rfft_axis_wrapper_1_m_axis_tvalid [get_bd_pins axis_mux_0/s_axis_tvalid_0] [get_bd_pins rfft_axis_wrapper_1/m_axis_tvalid]
  connect_bd_net -net rst_ps8_0_99M1_peripheral_aresetn [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins axis_demux_0/aresetn] [get_bd_pins axis_mux_0/aresetn] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins fifo_generator_0/s_aresetn] [get_bd_pins fifo_generator_1/s_aresetn] [get_bd_pins fifo_generator_2/s_aresetn] [get_bd_pins frame_extractor_0/resetn] [get_bd_pins hann_win_applayer_0/resetn] [get_bd_pins hann_win_applayer_1/resetn] [get_bd_pins neighbors_resize_wra_0/areset] [get_bd_pins rfft_axis_wrapper_0/aresetn] [get_bd_pins rfft_axis_wrapper_1/aresetn] [get_bd_pins threshold_axis_0/aresetn]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins spi_master_axis_0/reset_n]
  connect_bd_net -net spi_master_axis_0_cs_n [get_bd_ports cs] [get_bd_pins spi_master_axis_0/cs_n]
  connect_bd_net -net spi_master_axis_0_m_axis_tdata [get_bd_pins fifo_generator_0/s_axis_tdata] [get_bd_pins spi_master_axis_0/m_axis_tdata]
  connect_bd_net -net spi_master_axis_0_m_axis_tvalid [get_bd_pins fifo_generator_0/s_axis_tvalid] [get_bd_pins spi_master_axis_0/m_axis_tvalid]
  connect_bd_net -net spi_master_axis_0_mosi [get_bd_ports mosi_spi] [get_bd_pins spi_master_axis_0/mosi]
  connect_bd_net -net spi_master_axis_0_sclk [get_bd_ports sclk] [get_bd_pins spi_master_axis_0/sclk]
  connect_bd_net -net threshold_axis_0_m_axis_tdata [get_bd_pins system_ila_0/probe0] [get_bd_pins threshold_axis_0/m_axis_tdata]
  connect_bd_net -net threshold_axis_0_m_axis_tvalid [get_bd_pins system_ila_0/probe1] [get_bd_pins threshold_axis_0/m_axis_tvalid]
  connect_bd_net -net threshold_axis_0_s_axis_tready [get_bd_pins neighbors_resize_wra_0/m_axis_tready] [get_bd_pins threshold_axis_0/s_axis_tready]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins rfft_axis_wrapper_0/m_axis_tready] [get_bd_pins rfft_axis_wrapper_1/m_axis_tready] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins spi_master_axis_0/write_data] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins threshold_axis_0/m_axis_tready] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins neighbors_resize_wra_0/s_axis_tdata] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axis_demux_0/aclk] [get_bd_pins axis_mux_0/aclk] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins fifo_generator_0/s_aclk] [get_bd_pins fifo_generator_1/s_aclk] [get_bd_pins fifo_generator_2/s_aclk] [get_bd_pins frame_extractor_0/aclk] [get_bd_pins hann_win_applayer_0/aclk] [get_bd_pins hann_win_applayer_1/aclk] [get_bd_pins neighbors_resize_wra_0/aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rfft_axis_wrapper_0/aclk] [get_bd_pins rfft_axis_wrapper_1/aclk] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins spi_master_axis_0/clock] [get_bd_pins system_ila_0/clk] [get_bd_pins threshold_axis_0/aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk]
